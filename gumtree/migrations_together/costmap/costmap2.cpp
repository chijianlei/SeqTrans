...
#include <geometry_msgs/msg/point.hpp> //TODO, necessary?
...
bool Costmap::fromMsg(
    const sumet_nav_msgs::msg::Costmap& msg)
{
  *this = Costmap();
...
bool Costmap::fromMsg(
    const persistent_map_msgs::msg::LocalGridMap& msg)
{
  //ROS_ASSERT(msg.rows >= 0);
  //ROS_ASSERT(msg.columns >= 0);
  *this = Costmap();

  for (const persistent_map_msgs::msg::MapLayer& layer : msg.layers)
  {
...
void Costmap::toMsg(
    sumet_nav_msgs::msg::Costmap& msg) const
{
...
void Costmap::toMsg(
    persistent_map_msgs::msg::LocalGridMap& msg) const
{
  //set position
  ...
  persistent_map_msgs::msg::MapLayer layer;
  layer.name = "costmap";
